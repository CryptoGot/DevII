...
def main():
    ...
    parser.add_argument("-p", "--progressive", action="store_true", help="Affiche les résultats progressivement")
    parser.add_argument("-o", "--output-file", help="Nom du fichier où enregistrer les résultats")
